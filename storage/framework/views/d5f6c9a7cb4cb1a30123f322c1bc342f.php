...
<hr>
    ...
    <?php if($currentEpisode > $minAvailableEpisode): ?>
        <a class="btn btn-primary" href="<?php echo e($prevEpisode); ?>" >
            Previous Episode
        </a>
    <?php else: ?>
    ...
    <a class="btn btn-primary" href="<?php echo e($nextEpisode); ?>" >
            Next Episode
    </a>
    <?php else: ?>
        <a class="btn btn-secondary" href="#" disabled>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Na nowy dysk\semestr5\aplikacje\projekt\projekt_Kordalski_20192\resources\views/anime/show.blade.php ENDPATH**/ ?>